...
.td_label{
	...
	<xsl:template name="section">
		<xsl:call-template name="section-title">
			<xsl:with-param name="title" select="n1:code/@displayName"/>
		</xsl:call-template>
		...
		<xsl:for-each select="n1:entry">
			<xsl:call-template name="section-entry"/>
		</xsl:for-each>
	</xsl:template>
	<!-- process section entry blocks -->
	<xsl:template name="section-entry">
		<xsl:choose>
			<xsl:when test='n1:act/n1:entryRelationship/n1:observation'>
		<p>
			<b>
			<xsl:value-of select="n1:act/n1:entryRelationship/n1:observation/n1:code/@displayName"/>
			[
			<xsl:value-of select="n1:act/n1:entryRelationship/n1:observation/n1:code/@codeSystemName"/>
			=
			<xsl:value-of select="n1:act/n1:entryRelationship/n1:observation/n1:code/@code"/>
			]
			</b>
			:
