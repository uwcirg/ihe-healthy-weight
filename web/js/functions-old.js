...
//      }
      ...
      if (hasOc) {
          if (val.calculated_bmi >= 30 ) {
            if (val.occupation_23_code == selectedOc) { ocSelb++ }
            ocAllb++;
          } else if (val.calculated_bmi >= 25 ) {
            if (val.occupation_23_code == selectedOc) { ocSelo++ }
            ocAllo++;
          } else {
            if (val.occupation_23_code == selectedOc) { ocSeln++ }
            ocAlln++;
          }          
      }
      ...
      if (obsYear == 2008) {
        v08 += val.calculated_bmi;
        if (val.occupation_23_code == selectedOc) { s08 += val.calculated_bmi; s08c++; }
        if (val.calculated_bmi >= 30 ) {
          b08++;
        } else if (val.calculated_bmi >= 25 ) {
          o08++;
      ...
      } else if (obsYear == 2009) {
        v09 += val.calculated_bmi;
        if (val.occupation_23_code == selectedOc) { s09 += val.calculated_bmi; s09c++; }
        if (val.calculated_bmi >= 30 ) {
          b09++;
        } else if (val.calculated_bmi >= 25 ) {
          o09++;
        ...
        if (val.occupation_23_code == selectedOc) { s10 += val.calculated_bmi; s10c++; }
        if (val.calculated_bmi >= 30 ) {
          b10++;
        } else if (val.calculated_bmi >= 25 ) {
          o10++;
        ...
        if (val.occupation_23_code == selectedOc) { s11 += val.calculated_bmi; s11c++; }
        if (val.calculated_bmi >= 30 ) {
          b11++;
        } else if (val.calculated_bmi >= 25 ) {
          o11++;
        ...
        if (val.occupation_23_code == selectedOc) { s12 += val.calculated_bmi; s12c++; }
        if (val.calculated_bmi >= 30 ) {
          b12++;
        } else if (val.calculated_bmi >= 25 ) {
          o12++;
        ...
        if (val.occupation_23_code == selectedOc) { s13 += val.calculated_bmi; s13c++; }
        if (val.calculated_bmi >= 30 ) {
          b13++;
        } else if (val.calculated_bmi >= 25 ) {
          o13++;
        ...
        if (val.occupation_23_code == selectedOc) { s14 += val.calculated_bmi; s14c++; }
        if (val.calculated_bmi >= 30 ) {
          b14++;
        } else if (val.calculated_bmi >= 25 ) {
          o14++;
    ...
    options5.series.push({
      name: "Obese",
      data: [(b08/a08),(b09/a09),(b10/a10),(b11/a11),(b12/a12),(b13/a13),(b14/14)]
    },{
      name: "Overweight",
      data: [(o08/a08),(o09/a09),(o10/a10),(o11/a11),(o12/a12),(o13/a13),(o14/14)]
    },{
      name: "Normal",
      data: [(n08/a08),(n09/a09),(n10/a10),(n11/a11),(n12/a12),(n13/a13),(n14/14)]
    });
    
    options6.series.push({
      name: passedOccupation,
      data: [(s08/s08c),(s09/s09c),(s10/s10c),(s11/s11c),(s12/s12c),(s13/s13c),(s14/s14c)]
    },{
      name: "All",
      data: [(v08/a08),(v09/a09),(v10/a10),(v11/a11),(v12/a12),(v13/a13),(v14/a14)]
    });
